"""
ACZ: s3://pnp-data-lake-prod-acz-<>-euw1/..
STZ: s3://pnp-data-lake-prod-stz-<>-euw1/..
"""
...
class XXXX_DATASET_NAME_XXXXData(dataset):
    ...
    def __init__(self, configParams):
        ...
        self.local_hudi_options = {
          'hoodie.datasource.write.recordkey.field': 'XXXX_DATASET_KEYS_XXXX',
          'hoodie.datasource.write.partitionpath.field': 'XXXX_DATASET_PARTITION_BY_XXXX',
          'hoodie.datasource.hive_sync.partition_fields': 'XXXX_DATASET_PARTITION_BY_XXXX'
        }
        ...
        self.schemaDict[1]['cols'] = XXXX_SET_NUMBER_OF_COLUMNS_XXXX
        self.schemaDict[1]['validFrom'] = '20220901' # This is set to an arbitratry date in the past
        self.schemaDict[1]['validUntil'] = '29991231' # This is ostensibly set to whatever date this version of schema applies until
