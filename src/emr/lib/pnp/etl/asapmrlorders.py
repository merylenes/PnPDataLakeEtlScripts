"""
ACZ: s3://pnp-data-lake-dev-acz-ols-euw1/asap/td/orders/
STZ: s3://pnp-data-lake-dev-stz-ols-euw1/td/orders/asap_mrl_orders/
"""
...
class asapmrlordersData(dataset):
    ...
    def __init__(self, configParams):
        ...
        self.Schema = StructType([
            ...
            StructField("smart_shopper_no", StringType(), True),
            StructField("created_at", TimestampType(), True),
            StructField("updated_at", TimestampType(), True),
            StructField("billing_doc_no", IntegerType(), True),
            StructField("return_message", StringType(), True),
