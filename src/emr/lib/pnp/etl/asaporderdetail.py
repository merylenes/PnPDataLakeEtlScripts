"""
ACZ: s3://pnp-data-lake-prod-acz-ols-euw1/asap/td/order_detail/
STZ: s3://pnp-data-lake-prod-stz-ols-euw1/td/sales/sales_order_detail_01/
"""
...
class asaporderdetailData(dataset):
    ...
    def __init__(self, configParams):
        ...
        self.local_hudi_options = {
            'hoodie.datasource.write.recordkey.field': 'UID,ORDER_UID,PRODUCT_UID',
        ...
        self.Schema = StructType([
            ...
            StructField("SELLING_UNIT", StringType(), True),
            StructField("PRICE", StringType(), True),
            StructField("QUANTITY", StringType(), True),
            StructField("AMENDED_QUANTITY", StringType(), True),
            StructField("ADJUSTED_QUANTITY", StringType(), True),
            StructField("MARGIN", StringType(), True),
            StructField("OUT_OF_STOCK", StringType(), True),
            StructField("COMMENTS", StringType(), True),
            StructField("EDI_COST_PRICE", StringType(), True),
            StructField("EDI_RSP", StringType(), True),
            StructField("EDI_PROMO_PRICE", StringType(), True),
            StructField("PICKED", StringType(), True),
            StructField("OOS_QTY", IntegerType(), True),
            StructField("PICKED_METRIC", IntegerType(), True),
            StructField("PRODUCT_PROMOS_ID", IntegerType(), True),
        ...
        self.schemaDict[1]['validFrom'] = '20230906'
        self.schemaDict[1]['validUntil'] = '20990906'
