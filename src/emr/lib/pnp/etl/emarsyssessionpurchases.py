"""
ACZ: s3://pnp-data-lake-dev-acz-crm-euw1/ems/td/session_purchases/
STZ: s3://pnp-data-lake-dev-stz-crm-euw1/td/session_purchases/session_purchases_ems_session_purchases/
"""
...
class emarsyssessionpurchasesData(dataset):
    ...
    def __init__(self, configParams):
        ...
        self.local_hudi_options = {
            'hoodie.datasource.write.recordkey.field': 'user_id,items__item_id,order_id',
        ...
        StructField("items__item_id", StringType(), False),
        StructField("items__price", DecimalType(38, 24), True),
        StructField("items__qunatity", DecimalType(38, 24), True),
