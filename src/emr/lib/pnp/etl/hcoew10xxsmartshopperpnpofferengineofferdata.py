...
# ACZ: s3://pnp-data-lake-dev-acz-crm-euw1/bw/md/hcoew10/
# STZ: s3://pnp-data-lake-dev-stz-crm-euw1/md/offer_engine/offer_engine_bw_hcoew10/


# Please make sure the DATASET_NAME is lowecase - the whole thing. So NO PosCore. Rather poscore.
class hcoew10xxsmartshopperpnpofferengineofferdataData(dataset):
    ...
    def __init__(self, configParams):
        ...
        self.local_hudi_options = {
          'hoodie.datasource.write.recordkey.field': 'HCOEJOBID,HCRMKCAMP,HBPARTNER,HUNIT',
        ...
        self.Schema = StructType([
            ...
            StructField("HUNIT", StringType(), False),
            StructField("HCRMKCAMP", StringType(), False),
            StructField("HARTCLE_U", StringType(), False),
            StructField("HRANK", StringType(), False),
            StructField("HCFILLIND", StringType(), False),
            StructField("HCHITIND", StringType(), False),
            StructField("HCFILLCNT", IntegerType(), False),
            StructField("HCHITCNT", IntegerType(), False),
            StructField("HCTRXNCNT", IntegerType(), False),
            StructField("HSQTYSU", DecimalType(17,3), False),
            StructField("SALES_UNIT", StringType(), False),
            StructField("HSCENARIO", DecimalType(17,3), False),
            StructField("HRECN_SRE", DecimalType(17,3), False),
            StructField("HFREQ_SRE", DecimalType(17,3), False),
            StructField("HSPND_SRE", DecimalType(17,3), False),
            StructField("HREC_RANK", DecimalType(17,3), False),
            StructField("HFRQ_RANK", DecimalType(17,3), False),
            StructField("HSPD_RANK", DecimalType(17,3), False),
            StructField("HTOT_RANK", DecimalType(17,3), False),
            StructField("HFIN_SRE", DecimalType(17,3), False),
            StructField("HFIN_RANK", DecimalType(17,3), False),                                                                                    
            StructField("HFIN_ROW", DecimalType(17,3), False)])
        ...
        self.schemaDict[1]['validUntil'] = '20240124' # This is ostensibly set to whatever date this version of schema applies until
