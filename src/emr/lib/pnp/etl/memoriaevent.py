...
"""
ACZ: s3://pnp-data-lake-dev-acz-sud-euw1/memoria/td/event_memoria/
STZ: s3://pnp-data-lake-dev-stz-sud-euw1/td/audit/event_memoria/
"""
...
class memoriaeventData(dataset):
    ...
    def __init__(self, configParams):
        ...
        self.local_hudi_options = {
            'hoodie.datasource.write.recordkey.field': 'memoria_id',
