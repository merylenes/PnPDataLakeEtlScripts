"""
ACZ: s3://pnp-data-lake-prod-acz-retail-euw1/bw/td/hrrbm01/
STZ: s3://pnp-data-lake-prod-stz-retail-euw1/td/rebates/rebates_bw_hrrbm01/
"""
...
class pnprebatesdatamartData(dataset):
    ...
    def __init__(self, configParams):
        ...
        self.local_hudi_options = {
          'hoodie.datasource.write.recordkey.field': 'HPLANT,HMATERIAL,SALES_UNIT,HREBTYPE,HKSCHL',
        ...
        self.schemaDict[1]['validFrom'] = '20221026' # This is set to an arbitratry date in the past
        self.schemaDict[1]['validUntil'] = '20231026' # This is ostensibly set to whatever date this version of schema applies until
