...
# ACZ: s3://pnp-data-lake-dev-acz-retail-euw1/bw/td/hrsam06/
# STZ: s3://pnp-data-lake-prod-stz-retail-euw1/td/sales/sales_bw_hrsam06/


# Please make sure the DATASET_NAME is lowecase - the whole thing. So NO PosCore. Rather poscore.
class rateofsaleData(dataset):
    ...
    def __init__(self, configParams):
        ...
        self.local_hudi_options = {
          'hoodie.datasource.write.recordkey.field': 'HPLANT,HMATERIAL,CALDAY',
        ...
        self.Schema = StructType([
            ...
            StructField("HPROACTPR", StringType(), True),
            StructField("BASE_UOM", StringType(), True),
            StructField("HSQDRSXBU", DecimalType(17,3), True),
            StructField("HSQCRN1BU", DecimalType(17,3), True),
            StructField("HSQCRN2BU", DecimalType(17,3), True), 
            StructField("HSQCRP1BU", DecimalType(17,3), True), 
            StructField("HSQCRP2BU", DecimalType(17,3), True), 
            StructField("HSQPRS1BU", DecimalType(17,3), True), 
            StructField("HSQPRS2BU", DecimalType(17,3), True),
            StructField("HSVDROSLC", DecimalType(17,2), True), 
            StructField("HSVDROSGC", DecimalType(17,2), True),
            StructField("HSVDRSNLC", DecimalType(17,2), True), 
            StructField("HSVDRSNGC", DecimalType(17,2), True),
            StructField("HSVDCALLC", DecimalType(17,2), True), 
            StructField("HSVDCFRLC", DecimalType(17,2), True), 
            StructField("HSVDCCPLC", DecimalType(17,2), True), 
            StructField("HSRDROSBU", DecimalType(17,3), True), 
            StructField("HSRCROSBU", DecimalType(17,3), True),
            StructField("HSRPROSBU", DecimalType(17,3), True), 
            StructField("HSRPRSWBU", DecimalType(17,3), True), 
            StructField("HSRDRSNLC", DecimalType(17,2), True), 
            StructField("HSRDROSLC", DecimalType(17,2), True), 
            StructField("HSRDROSGC", DecimalType(17,2), True), 
            StructField("HSRDCALLC", DecimalType(17,2), True), 
            StructField("HSRDCFRLC", DecimalType(17,2), True),
            StructField("HSRDCCPLC", DecimalType(17,2), True), 
            StructField("HDRSDAY_X", IntegerType(), True), 
            StructField("HCRSWK1_X", IntegerType(), True), 
            StructField("HCRSWK2_X", IntegerType(), True), 
            StructField("HPRSWK1_X", IntegerType(), True), 
            StructField("HPRSWK2_X", IntegerType(), True), 
            StructField("HFINCDY_X", IntegerType(), True),
        ...
        self.schemaDict[1]['cols'] = 41
        self.schemaDict[1]['validFrom'] = '20221212' # This is set to an arbitratry date in the past
        self.schemaDict[1]['validUntil'] = '20231212' # This is ostensibly set to whatever date this version of schema applies until
